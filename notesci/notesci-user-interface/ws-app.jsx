  ...
  return (
    <>
      <DesignCanvas title="notesci · workspace" subtitle="Five layout modes for a research-grounded chat product · grounded in the sign-in design system" initialZoom={0.42}>
        ...
        <DCSection id="invites" title="05 · Invites · &quot;Invite · 3 left&quot; pill in the top bar opens a modal that mirrors the post-onboarding invite screen">
          <DCArtboard id="invite-modal" label="Invite modal · open over default workspace" width={1440} height={900}>
            <ModeDefault graphMode={t.graphMode} setGraphMode={setMode} layout="default" inviteOpen={true}/>
          </DCArtboard>
        </DCSection>

        <DCSection id="empty" title="06 · Empty states">
