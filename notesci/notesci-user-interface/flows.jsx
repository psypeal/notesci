    ...
    <div style={{ width, height, background:"var(--paper)", display:"flex", flexDirection:"column", padding:"40px 56px" }}>
      ...
      <div style={{ flex:1, display:"grid", gridTemplateColumns:"1fr 1.2fr", gap:64, paddingTop:48 }}>
        <div>
          ...
          <p style={{ fontSize:15, color:"#3a342c", lineHeight:1.55, maxWidth:420 }}>Each notesci member gets 3 invites for the early-access period. Use them on people whose reading you'd want to learn from.</p>
        ...
        <div>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:12 }}>
            <div className="mono" style={{ fontSize:11, letterSpacing:".1em", color:"var(--muted)" }}>YOUR CODES · 3 ALLOCATED · 3 LEFT</div>
