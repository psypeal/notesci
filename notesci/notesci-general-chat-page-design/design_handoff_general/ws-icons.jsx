...
const Icons = {
  ...
  panel:     (p={}) => <Icon {...p}><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 3v18"/></Icon>,
  panelFilled:(p={}) => (
    <svg width={p.size||16} height={p.size||16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink:0, ...(p.style||{}) }}>
      <rect x="3" y="3" width="18" height="18" rx="2"/>
      <path d="M9 3v18"/>
      <rect x="3.5" y="3.5" width="5.5" height="17" rx="1.5" fill="currentColor" opacity=".18" stroke="none"/>
    </svg>
  ),
