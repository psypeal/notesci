...
worker = (
    ...
    "\n"
    "const ROUTES = {\n"
    "  // HTML always revalidates (max-age=0) so a deploy is visible on the next\n"
    "  // load; the versioned CSS/icon URLs below keep their long cache.\n"
    "  '/': () => TEXT(HTML, 'text/html; charset=utf-8', 0),\n"
    "  '/index.html': () => TEXT(HTML, 'text/html; charset=utf-8', 0),\n"
